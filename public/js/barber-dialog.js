(function () {
    ...
    styles.textContent = `
        ...
        .bc-dialog-card{position:relative;width:min(430px,100%);overflow:hidden;border:1px solid rgba(201,162,39,.25);border-radius:22px;background:#fff;box-shadow:0 28px 75px rgba(28,28,28,.28);transform:translateY(12px) scale(.97);transition:transform .24s cubic-bezier(.22,.8,.24,1)}
        .bc-dialog-layer.open .bc-dialog-card{transform:none}
        .bc-dialog-accent{height:4px;background:#C9A227}
        .bc-dialog-layer[data-tone="danger"] .bc-dialog-accent{background:#C62828}
        .bc-dialog-layer[data-tone="success"] .bc-dialog-accent{background:#2E7D32}
        .bc-dialog-content{padding:25px 26px 20px;text-align:center}
        .bc-dialog-icon{width:54px;height:54px;display:grid;place-items:center;margin:0 auto 15px;border-radius:17px;background:rgba(201,162,39,.12);color:#C9A227}
        .bc-dialog-layer[data-tone="danger"] .bc-dialog-icon{background:rgba(198,40,40,.1);color:#C62828}
        .bc-dialog-layer[data-tone="success"] .bc-dialog-icon{background:rgba(46,125,50,.1);color:#2E7D32}
        ...
        .bc-dialog-title{margin:0;color:#1C1C1C;font:800 20px/1.25 'Manrope','DM Sans',sans-serif;letter-spacing:-.4px}
        .bc-dialog-message{margin:9px auto 0;max-width:340px;color:#6f6b64;font:500 13px/1.55 'DM Sans',sans-serif}
        ...
        .bc-dialog-cancel{border:1px solid #E5E0D6;background:#F8F5EE;color:#1C1C1C}
        .bc-dialog-confirm{background:#C9A227;color:#fff;box-shadow:0 7px 16px rgba(201,162,39,.22)}
        .bc-dialog-layer[data-tone="danger"] .bc-dialog-confirm{background:#C62828;box-shadow:0 7px 16px rgba(198,40,40,.2)}
        .bc-dialog-layer[data-tone="success"] .bc-dialog-confirm{background:#2E7D32;box-shadow:0 7px 16px rgba(46,125,50,.2)}
