    ...
    <div class="container hero-grid">
        <div>
            ...
            <p>
                ...
                detalle y atención personalizada. Sin necesidad de tener todas las fotos aún,
                ya puedes presentar una marca sólida, elegante y lista para crecer.
            </p>
...
<section id="servicios">
    <div class="container">
        ...
        <p class="section-copy">
            La página de referencia destaca sus rituales y experiencias como una parte central de la propuesta;
            aquí hacemos lo mismo, pero con el estilo visual de BarberCore y usando tus servicios actuales. :contentReference[oaicite:3]{index=3}
        </p>
...
<section id="espacio">
    <div class="container grid-2">
        <div class="panel">
            ...
            <p class="section-copy">
                La landing de referencia también muestra su espacio y experiencia de marca;
                aquí dejamos una sección equivalente para que luego la alimentes con imágenes reales del local. :contentReference[oaicite:4]{index=4}
            </p>
...
<section>
    <div class="container">
        <div class="cta">
            ...
            <p>
                Cuando quieras, esta sección puede conectarse después a citas, formulario de contacto
                o reservas. Por ahora queda lista como CTA comercial principal.
            </p>
    ...
    <div class="container footer-grid">
        <div>
            ...
            <div class="footer-copy">
                ...
                {{ $barberia->direccion ?? 'Dirección pendiente por actualizar' }}
            </div>
        </div>
        ...
        <div>
            ...
            <div class="footer-list">
                <div>{{ $barberia->telefono ?? 'Teléfono pendiente' }}</div>
                <div>
        ...
        <div>
            ...
            <div class="footer-list">
                ...
                <div><a href="#espacio">Nuestro espacio</a></div>
